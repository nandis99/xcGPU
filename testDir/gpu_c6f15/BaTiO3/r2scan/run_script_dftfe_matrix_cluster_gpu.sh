...
for exc in  MGGA-R2SCAN;do
    for useLibxc in false true;do
        ...
        outFile="BaTiO3_scf_useLibxc_${useLibxc}_xc_${exc}_c6f15.out"
        # outFile_pgd="BaTiO3_scf_useLibxc_${useLibxc}_xc_${exc}_pgd.out"
