...
mpirun -n $SLURM_NTASKS $exe ${param_file1} > BaTiO3_scf_r2scan_libxc_false_4.8M_dofs_denQuad_20_new.out
mpirun -n $SLURM_NTASKS $exe ${param_file2} > BaTiO3_scf_r2scan_libxc_false_7.6M_dofs_denQuad_20_new.out